...
const AdminAttendance = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-r from-purple-100 to-pink-100 p-8 min-h-screen">
      ...
      <button
        ...
        className="mt-6 bg-purple-600 text-white px-6 py-2 rounded hover:bg-indigo-700 shadow"
      >
        Submit Attendance
      </button>
    </div>
